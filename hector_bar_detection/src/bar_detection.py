...
class BarDetection:
    ...
    def contour_detection(self, mask, detection_image):
        ...
        filtered_contours = filter(
            lambda cnt: cv2.contourArea(cnt) > self.min_contour_area, contours
        )
        ...
        img_with_contours = cv2.drawContours(
            detection_image, filtered_contours, -1, (255, 0, 0), 2
        )
    ...
    def fit_lines(self, contours, detection_image):
        ...
        for cnt in contours:
            ...
            detection_image = cv2.line(
                detection_image, (cols - 1, righty), (0, lefty), (0, 255, 0), 2
            )
            ...
            detection_image = cv2.drawMarker(
                detection_image,
