#ifndef HECTOR_COLOR_DETECTION_NODE_H
#define HECTOR_COLOR_DETECTION_NODE_H
...
#include <hector_color_detection_nodelet/ColorDetectionConfig.h>
...
class ColorDetection : public nodelet::Nodelet
{
...
private:
  ...
  ros::Publisher color_marker_publisher_;
  ...
  // Dynamic reconfigure
  dynamic_reconfigure::Server<hector_color_detection_nodelet::ColorDetectionConfig> dynamic_recf_server;
  dynamic_reconfigure::Server<hector_color_detection_nodelet::ColorDetectionConfig>::CallbackType
      dynamic_recf_type;
  void dynamic_recf_cb( hector_color_detection_nodelet::ColorDetectionConfig &config, uint32_t level );
  image_transport::CameraPublisher pub_imageDetection;
  void publish_rectangle_for_recf( std::vector<cv::KeyPoint> keypoints,
...
#endif // HECTOR_COLOR_DETECTION_NODE_H
