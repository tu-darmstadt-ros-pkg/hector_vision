...
DetectionAggregator::DetectionAggregator()
{
    ...
    image_percept_sub_ = n.subscribe("detection/image_detection", 1 , &DetectionAggregator::imageDetectionCallback, this);
     dyn_rec_server_.setCallback(boost::bind(&DetectionAggregator::dynRecParamCallback, this, _1, _2));

    image_detected_pub_ = image_detected_it.advertiseCamera("detection/aggregated_detections", 10);
